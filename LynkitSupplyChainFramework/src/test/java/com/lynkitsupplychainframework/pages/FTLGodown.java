...
public class FTLGodown {
WebDriver driver;

public FTLGodown(WebDriver ldriver)
{
	this.driver=ldriver;
}
...
@FindBy(xpath="//li[contains(text(),'Paid')]") WebElement lrTypeCredit;
...
@FindBy(xpath="//li[contains(text(),'Train')]") WebElement transModeRoad;
...
@FindBy(xpath="/html[1]/body[1]/span[1]/span[1]/span[2]/ul[1]/li[2]") WebElement consignorName;
...
@FindBy(xpath="/html[1]/body[1]/span[1]/span[1]/span[2]/ul[1]/li[1]") WebElement consigneeName;
...
@FindBy(xpath="//div[14]//div[1]//div[1]//div[1]//div[1]") WebElement riskYes;
...
@FindBy(xpath="/html[1]/body[1]/app-root[1]/app-receipt-create[1]/main[1]/div[1]/div[2]/div[1]/form[1]/div[15]/div[2]/div[1]/div[1]/span[1]/span[1]/span[1]") WebElement delFrom;
@FindBy(xpath="//li[contains(text(),'Mayapuri')]") WebElement selectDelFrom;
...
@FindBy(xpath="//div[@class='row absol multimodcont']//div[1]//div[1]//input[1]") WebElement trainNo;
	
@FindBy(xpath="//div[@class='row absol multimodcont']//div[2]//div[1]//input[1]") WebElement trainName;
	
@FindBy(xpath="//input[@id='modeDate-0']") WebElement trainDate;
	
@FindBy(xpath="/html[1]/body[1]/app-root[1]/app-receipt-create[1]/main[1]/div[1]/div[2]/div[1]/form[1]/div[23]/div[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/span[1]/span[1]/span[1]") WebElement fromState;
@FindBy(xpath="//li[contains(text(),'Uttar Pradesh')]") WebElement fromStateUP;
	@FindBy(xpath="//span[@id='select2-fromCity-0-container']") WebElement fromCity;
	@FindBy(xpath="//li[contains(text(),'Kanpur')]") WebElement fromKanpur;
	
	@FindBy(xpath="//input[@id='fromRailwaySt-0']") WebElement fromRailwayStation;
	@FindBy(xpath="//div[@class='form-group from_pincode_div0']//input[@class='form-control ng-untouched ng-pristine ng-valid']") WebElement fromPinCode;
	
	@FindBy(xpath="//div[@class='form-group']//span[@class='select2 select2-container select2-container--bootstrap']//span[@class='select2-selection select2-selection--single form-control']") WebElement toState;
	@FindBy(xpath="//li[contains(text(),'Delhi')]") WebElement toStateDelhi;
	@FindBy(xpath="//span[@id='select2-toCity-0-container']") WebElement toCity;
	@FindBy(xpath="//li[contains(text(),'Delhi')]") WebElement toDelhi;
	@FindBy(xpath="//input[@id='toRailwaySt-0']") WebElement toRailwayStation;
	@FindBy(xpath="//div[@class='col-3']//div[@class='form-group']//input[@class='form-control ng-untouched ng-pristine ng-valid']") WebElement toPinCode;
...
public void paymentDetails(String createAdvFreight,String createFCharge, String createExpDate) throws InterruptedException
{
	...
	*/
    ...
    public void transportDetails(String etrainNo,String etrainName, String etrainDate) throws InterruptedException
    {
 	trainNo.sendKeys(etrainNo);
 	Thread.sleep(2000);
 	trainName.sendKeys(etrainName);
 	Thread.sleep(2000);
 	trainDate.sendKeys(etrainDate);
 	Thread.sleep(2000);
 	...
 	fromKanpur.click();
 	Thread.sleep(2000);
 	fromRailwayStation.sendKeys("test From Railway Station");
 	Thread.sleep(2000);
 	fromPinCode.sendKeys("110022");
 	Thread.sleep(2000);
 	...
 	toRailwayStation.sendKeys("test From Railway Station");
 	Thread.sleep(2000);
 	toPinCode.sendKeys("110028");
 	Thread.sleep(2000);
}
