...
import com.lynkitsupplychainframework.pages.GRFullTruck;
import com.lynkitsupplychainframework.utility.ExcelDataProvider;

public class GRFullTruckTest extends BaseClass{
	//WebDriver driver;
	...
	//driver=BrowserFactory.startApplication(driver, "Chrome", "https://lynkit.io/login");
		...
		GRFullTruck loginPage=PageFactory.initElements(driver, GRFullTruck.class);
